...
namespace Finance.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public ActionResult Create(int acctId)//pass the accountid from the view
        {
            ...
            // since we passed the int acctId above
        ...
        public ActionResult Create([Bind(Include = "Id,AccountId,Description,Date,Amount,Type,Void,CategoryId,EnteredById,Reconciled,ReconciledAmount,IsDeleted")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Details","PersonalAccounts", new { id = transaction.AccountId });//
            }
